...
$title[Permissions]
$description[Unsure about what perms the bot should have? This list should help you decide the right permissions for the bot!

For safety reasons, avoid granting the bot administrator permission under any circumstances.
]
$addField[\`ViewChannel\`;Required so the bot can read the user's messages executing its command.]
