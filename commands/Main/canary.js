...
$addField[How to test?;For those who want to run the latest build on their bots. You can download the files from the $hyperlink[canary;https://github.com/ddodogames/Dodo-Bot/tree/canary] branch on GitHub.
