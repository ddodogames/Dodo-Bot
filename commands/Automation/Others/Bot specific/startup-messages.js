...
console.log(chalk.cyan("Invite Your bot using this link: $getClientInvite[sendmessages;viewchannel;addreactions;attachfiles;viewauditlog;embedlinks]"))
]
$djsEval[const chalk = require('chalk')
