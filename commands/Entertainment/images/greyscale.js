module.exports = {
    name: "greyscale",
    info: {
        description: "Adds greyscale effect to a image.",
        usage: "`greyscale (user)`",
        perms: ["`SendMessages`", "`AttachFiles`"]
    },
    code: `$attachment[$get[apilink];greyscale.png;URL]
    ...
    $let[apilink;https://api.popcat.xyz/v2/greyscale?image=$get[pfphandler]]
    $let[pfphandler;$advancedReplaceText[$userAvatar[$mentioned[1;true]];.webp;.png;.gif;.png]]
    $cooldown[5s; Slow down! Don't spam the command!
    Time remaining: <t:$truncate[$divide[$sum[$getCooldownTime[5s;user;greyscale;$authorID];$dateStamp];1000]]:R>]`
}
